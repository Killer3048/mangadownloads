...
import { normalizeBubbleClassMap } from "./bubbleClasses";
...
const storedBubbleClassMap = normalizeBubbleClassMap(storage.data?.bubbleClassMap);
...
const reducer = (state, action) => {
  ...
  case "setBubbleReadingOrder": {
    const v = (action.readingOrder || action.order || action.direction || "ltr").toString().toLowerCase();
    newState.bubbleReadingOrder = v === "rtl" ? "rtl" : "ltr";
    break;
  }
    ...
    case "setBubbleClassMap": {
      newState.bubbleClassMap = normalizeBubbleClassMap(action.value);
      break;
    }
  ...
  newState.bubbleClassMap = normalizeBubbleClassMap(newState.bubbleClassMap);
